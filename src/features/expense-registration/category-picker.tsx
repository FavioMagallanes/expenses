    ...
    <div className="flex flex-col gap-1 w-full">
      ...
      <div className="relative">
        <select
          ...
          className={`w-full appearance-none border border-ds-border rounded-lg bg-surface px-3 py-2.5 pr-10 text-sm outline-none transition-all focus:ring-1 focus:ring-primary/50 cursor-pointer [&>option]:font-normal [&>option]:text-ds-text [&>option]:bg-white ${isDefault ? 'text-ds-secondary font-normal' : 'text-ds-text font-medium'}`}
        >
